                    ...
                    <table className="w-full text-sm text-left rtl:text-right text-zinc-500">
                        ...
                        <tbody>
                            {rows.map(row => (
                                <tr key={row.id}>
                                    <td>
                                        <select className="w-full md:w-36 border-zinc-700 rounded-md dark:bg-zinc-800" value={row.product} onChange={e => handleInputChange(row.id, 'product', e.target.value)} required>
                                    ...
                                    <td>
                                        <select className="w-full md:w-36 border-zinc-700 rounded-md dark:bg-zinc-800" value={row.classification} onChange={e => handleInputChange(row.id, 'classification', e.target.value)} required>
                                    ...
                                    <td>
                                        <select className="w-full md:w-24 border-zinc-700 rounded-md dark:bg-zinc-800" value={row.gender} onChange={e => handleInputChange(row.id, 'gender', e.target.value)} required>
                                    ...
                                    <td>
                                        <select className="w-20 border-zinc-700 rounded-md dark:bg-zinc-800" value={row.upper_size} onChange={e => handleInputChange(row.id, 'upper_size', e.target.value)} required>
                                    ...
                                    <td>
                                        <select className="w-20 border-zinc-700 rounded-md dark:bg-zinc-800" value={row.lower_size} onChange={e => handleInputChange(row.id, 'lower_size', e.target.value)} required>
                                            <option value="" disabled selected>Select Size</option>
                                            <option value="XS">XS</option>
                                            <option value="S">S</option>
                                            <option value="M">M</option>
