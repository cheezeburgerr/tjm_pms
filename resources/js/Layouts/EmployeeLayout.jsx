...
export default function EmployeeLayout({ user, children }) {
    ...
    return (
        <div className=" dark:bg-neutral-950 min-h-screen bg-gray-100 dark:bg-gray-900 dark:text-white flex">
            {/* {route().current('employee.dashboard') && (
                <div className='w-full h-56 bg-teal-500 absolute top-0 -z-[0]'>hello</div>
            )} */}
            <aside>
                <div id="drawer-sidebar" className={`sticky top-0 z-50 bg-gray-50 dark:bg-neutral-950 w-64 h-screen transition duration-300 ${isDrawerOpen ? 'transform translate-x-0' : '-translate-x-full sm:translate-x-0'
                    }`}>
                    <div className=" mb-4 py-2">
                        <h1 className="font-bold text-2xl flex gap-2 text-aqua px-6 py-4 "><img src='/images/TJM_LOGO.png' className='h-8' />Sportswear</h1>
                    </div>
                    ...
                    <ul>
                        ...
                        <li className="mb-2">
                            <DashboardLink href={route('products.index')} className="text-gray-500 hover:text-gray-900 inline-flex gap-2 px-6" active={route().current('products.index')}>
                                {/* <span><Home color={'teal'} height="20px" /></span> */}Products
                            </DashboardLink>
                        </li>
                        <li className="mb-2">
            ...
            <main className="sm:w-full w-full absolute sm:relative left-0">
                ...
                <nav class="bg-gray-100 dark:bg-neutral-950 dark:text-gray-100 z-20 sticky top-0 p-3 flex flex-row-reverse">
