...
function Table({ columns, data }) {
  const {
  ...
  } = useTable(
    {
      columns,
      data,
      initialState: { pageIndex: 0 }, // Pass our default page size here
    },
  ...
  return (
    <>
      ...
      <div className="border border-zinc-300 dark:border-zinc-700 rounded-md mb-4">
            ...
            return (
              ...
              >
                {row.cells.map((cell) => {
                  return (
                    <td
                      className="hover:dark:bg-zinc-800 hover:bg-zinc-300 px-4 p-2"
                      {...cell.getCellProps()}
                      key={cell.id}
                    >
                      {cell.render("Cell")}
      ...
      <span>
        ...
        <select className="w-20 border-zinc-300 shadow-sm dark:border-zinc-700 rounded-md dark:bg-zinc-800"
          value={pageSize}
          onChange={(e) => {
